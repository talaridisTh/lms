...
const topicsDatatable = $("#topics-datatable").DataTable({
	...
	columns: [
		{data: 'action', name: 'action', className: "text-center", width: "5%", orderable: false },
		{data: 'title', name: 'title' },
		{data: 'updated_at', name: 'updated_at', className: "text-center cursor-default js-updated-at" },
