  ...
  <div class="app-modal" data-name="delete">
      <div class="app-modal-container">
          <div class="app-modal-card" data-name="delete" data-modal='0'>
              <div class="app-modal-header">Είστε βέβαιοι ότι θέλετε να το διαγράψετε;</div>
              <div class="app-modal-body">Δεν μπορείτε να αναιρέσετε αυτήν την ενέργεια</div>
              <div class="app-modal-footer">
                  <a href="javascript:void(0)" class="app-btn cancel">Ακύρωση</a>
                  <a href="javascript:void(0)" class="app-btn a-btn-danger delete">Διαγραφή</a>
              </div>
          </div>
      </div>
  </div>
      ...
      <div class="app-modal-container">
          <div class="app-modal-card" data-name="settings" data-modal='0'>
              <form id="updateAvatar" action="{{ route('avatar.update') }}" enctype="multipart/form-data" method="POST">
                  @csrf
                  <div class="app-modal-header">Ενημερώστε τις ρυθμίσεις του προφίλ σας</div>
                  <div class="app-modal-body">
                      ...
                      <label class="app-btn a-btn-primary update">
                          Μεταφόρτωση φωτογραφίας προφίλ
                          <input class="upload-avatar" accept="image/*" name="avatar" type="file" style="display: none" />
                      </label>
                      {{-- Dark/Light Mode  --}}
                      <p class="divider"></p>
                      <p class="app-modal-header">Σκοτεινή λειτουργία<span class="
