    ...
    <div class="spa-material">
                ...
                <section class="flex justify-between">
                    ...
                    <figure class="text-xl items-center space-x-3 flex hidden">
                        @if($curator->facebook_link)
                            <img src="{{asset("images/facebook-1.png")}}"
                                 alt="">
                        @endif
                        @if($curator->instagram_link)
                            <img src="{{asset("images/linked-in.png")}}"
                                 alt="">
                        @endif
                        @if($curator->linkedin_link)
                            <img src="{{asset("images/twitter-1.png")}}"
                                 alt="">
                        @endif
        ...
        <div class="rounded mx-auto mt-7">
            ...
            <div id="tab-contents"
                ...
                @endif
                <div id="first"
                     class=" hidden py-6 px-4">

                    {!! $model->description !!}
                </div>
                <div id="second"
                     class="hidden py-6 px-4 list-inside">
                ...
                <figure id="fourth"
                        class="hidden py-6 px-4 flex flex-wrap space-x-4">
                ...
                <div id="disscussion"
                    ...
                    @include("components.index.comments.comments-main",["model"=>$model,"namespace"=>get_class($model)])
                </div>
            </div>
        </div>
    </div>
