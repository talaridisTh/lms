<header id="header"
    ...
    <div class="container mx-auto max-w-1xl inline-flex sm:flex flex-wrap items-center px-1 intro-x">
        <div class="w-full flex-1 xl:inline-flex flex justify-between items-center">
			...
			@guest
				<a class="bg-login text-white px-4 py-3 rounded-full flex md:hidden focus:outline-none" href="{{ route("login") }}">
					<svg viewBox="0 0 24 24" width="22" height="22" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round" class="css-i6dzq1"><path d="M15 3h4a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2h-4"></path><polyline points="10 17 15 12 10 7"></polyline><line x1="15" y1="12" x2="3" y2="12"></line></svg>
        ...
        <div class="hidden md:flex md:items-center md:w-auto w-full"
            ...
            <nav class="top-nav">
				@auth
					...
					@endauth
					@guest
						<a class="bg-login text-white px-4 py-3 rounded-full flex" href="{{ route("login") }}">
							<svg viewBox="0 0 24 24" width="22" height="22" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round" class="css-i6dzq1"><path d="M15 3h4a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2h-4"></path><polyline points="10 17 15 12 10 7"></polyline><line x1="15" y1="12" x2="3" y2="12"></line></svg>
							<span class="ml-3">Σύνδεση</span>
						</a>
					@endguest
