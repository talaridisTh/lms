...
<div class="main-post d-flex mt-2" data-post-id="{{$post->id}}" style="background-color: rgba(0, 0, 0, 0.1)">
    ...
    <div>
        ...
        <h2 class="bg-thread px-3 py-1 font-16 text-dark d-inline-block mr-2 mb-4">{{$post->title}}</h2>
        <p>{{$post->body}}</p>
    </div>
</div>
...
<div class="form-group  mt-4 replay-bottom  mb-2 {{$closedHide}}">
    <p class="p-4 text-dark input-task font-20"><i class="mdi mdi-hand-pointing-down font-18 mr-2"></i> Απαντησε στο Post</p>
</div>
