...
@section("content")
    ...
    <section class="d-flex wrapper flex-column">
        ...
        <div class=" container text-center ">
            ...
            <iframe src="https://player.vimeo.com/video/449242504?color=d42929&title=0&byline=0&portrait=0" width="640"
                            ...
                            <div class="col-md-12  border d-flex justify-content-between"
                                ...
                                <div class="col-md-10 ">
                                    <a class="d-flex justify-content-center flex-column"
                                       href="#">
                                        <span
                                            class="font-16  text-center text-black font-weight-bold">Title of course </span>
