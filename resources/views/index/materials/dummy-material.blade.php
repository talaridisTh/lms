...
@section("content")
    ...
    <section class="d-flex wrapper flex-column">
        @role("admin")
        <div class="">
            <a class=" btn btn-outline-secondary nav-link" href="{{route('material.show',$materials->slug)}}" role="button"
        ...
        @endrole
            ...
            <div class=" container text-center ">
                    ...
                    <iframe src="https://vimeo.com/449242504" width="1024" height="768" frameborder="0"
                        ...
                        <div class="col-md-6 p-3">
                            <div class="row">
                                ...
                                <div class="col-md-8 text-white">
                                    ...
                                    Μάθημα 1 - {{$materials->created_at->format("d-m-y")}}
                                </span>
                                    <p class="mt-3  font-weight-bold">Μάθημα
                                        <a class="" href="#">
                                            <span class="course-title">Title of course 1 </span>
                                        </a>
                                    </p>
                                </div>
                            </div>
            ...
            <div class="row ">
                ...
                <div class="col-md-3 pl-3">
                    <div class="row hover-yellow">
                        <div class="col-md-12  border d-flex justify-content-between"
                            ...
                            <div class="col-md-10 ">
                                <a class="d-flex justify-content-center flex-column"
                                   href="#">
                                    <span class="font-16  text-center text-black font-weight-bold">Title of course </span>
                                    <div class="d-flex justify-content-around">
                                        <span class="font-12 text-primary">Μέτριο</span>
                                        <span class="font-12">1 Μάθηματα</span>
                                    </div>
                                </a>
                            </div>
                        </div>
                        ...
                        <div
                            class="row my-2 material-title material-title-hover ">
                            <div class="col-md-12 material-title cursor-pointer  border d-flex justify-content-between"
                                ...
                                <div class="col-md-10 ">
                                    <a class="d-flex justify-content-center flex-column"
                                       href="#">
                                <span
                                    class="font-16 text-center text-black font-weight-bold">{{$materials->title}}</span>
                                        <div class="d-flex justify-content-around">
                                            <span class="font-12"> Μάθημα 1</span>
                                        </div>
