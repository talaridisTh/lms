            ...
            <div class="container">
                <div class="row  position-relative py-4">
                    ...
                    <div class="col-md-8  text-light">
                        <p>breadcrumb </p>
                        <div class="col-md-4 d-flex d-sm-none justify-content-center
 ">
                        ...
                        @foreach($materials->users as $user)
                            <span
                                class="font-14 font-italic cursor-pointer custom-link-primary">{{$user->fullName}},</span>
                        @endforeach
                        <div class="dateMaterial d-flex mt-3">
                            <p class="font-14 mr-3"><i class=" mr-1  mdi mdi-autorenew"></i>Τελευταία
                                ενημέρωση: {{$materials->updated_at}}</p>
                            <p class="font-14"><i
                                    class="mdi mr-1 mdi-new-box"></i>Δημιουργήθηκε: {{$materials->created_at->diffForHumans()}}
                            </p>
                        </div>
                    </div>
                        ...
                        <div class="inscructor-material ">
                            ...
                            <div class="col-md-8 d-flex align-items-center">
                                <div class="image-insructor">
                                    <img height="100" class=" rounded-circle " src="{{$user->avatar}}"
                                         alt="{{$user->avatar}}-logo">
                                </div>
                                <div class="">
                                    <p class=" mb-1 font-14 font-weight-bold text-dark"><i
                                            class=" dripicons-user mr-2"></i> {{$user->fullName}}</p>
                                    <p class="mb-1 font-14 font-weight-bold text-dark"><i
                                            class=" mdi mdi-email-sync mr-2"></i>{{$user->email}}</p>
                                    <p class="mb-1 font-14 font-weight-bold text-dark"><i
                                            class="mr-2 mdi mdi-book-open-page-variant"></i>
