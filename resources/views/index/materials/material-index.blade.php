...
<section class="d-flex wrapper flex-column">
    ...
    <div class=" container text-center ">
        @if(strlen($materials->video_link)<12 ) <iframe src="https://player.vimeo.com/video/{{$materials->video_link}}"
            width="1024" height="768" frameborder="0" allow="autoplay; fullscreen" allowfullscreen></iframe>
            @else
                    ...
                    <div class="col-md-12  border d-flex justify-content-between"
                        ...
                        <div class="col-md-10 ">
                            <a class="d-flex justify-content-center flex-column"
                                ...
                                <span class="font-16  text-center text-black font-weight-bold">{{$course->title}}</span>
