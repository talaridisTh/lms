...
@section("content")
    ...
    <div id="lessons-slide"
         class="custom-container  splide mx-auto">
                                    ...
                                    <a href="{{route('index.showCourse',$course->slug)}}"
                                       class="relative  block my-4 md:my-0 w-full h-auto">
                                        <svg viewBox="0 0 33.83098862 33.83098862"
                                             ...
                                             class="circle-chart "
                                             style="margin: -7px;">
                                            <circle stroke="rgba(0, 0, 0, .2)"
                                                    stroke-width="1"
                                                    fill="none"
                                                    cx="16.91549431"
                                                    cy="16.91549431"
                                                    r="15.91549431"
                                                    class="circle-chart__background"></circle>
                                            <circle stroke="white"
                                                    stroke-width="1"
                                ...
                                <div class="cnt-card relative flex flex-col justify-around my-5">
                                    ...
                                    <div class="hidden lg:flex expanded-card-meta text-grey-dark text-2xs">
                                        <div class=" flex items-center mr-4 text-xs	 space-x-3 text-gray-500">
                                            ...
                                            <p class="inherits-color link no-transition">{{$countLessons[$course->slug]["lesson"]}}
                                                Μαθήματα</p>
                                        ...
                                        <div class="hidden  expanded-card-meta-length items-center">
                                            <svg xmlns="http://www.w3.org/2000/svg"
                                                 ...
                                                 height="13"
                                                 viewBox="0 0 13 13"
                                                 class="inherits-color mr-2 relative"
                                                 style="top: 1px;">
