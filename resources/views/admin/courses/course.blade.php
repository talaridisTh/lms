...
@section('content')
    <div class="modal fade" id="add-material-modal" tabindex="-1" aria-labelledby="add-material-modalLabel"
         aria-hidden="true">
    ...
    <div id="add-user-modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="add-user-modalLabel"
         aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body table-cnt">
                    <table id="add-users-list"
                           class="js-table table w-100 nowrap modal-table custom-center-table center-not-second js-remove-table-classes">
                        <thead>
                        <tr>
                            <th class="select-all w-5">
                                <div class='icheck-primary d-inline'>
                                    <input class='js-course-checkbox' type='checkbox' id='add-user-checkbox'
                                           autocomplete='off'>
    ...
    <div id="add-materials-modal" class="modal fade" tabindex="-1" role="dialog"
         aria-labelledby="add-materials-modalLabel" aria-hidden="true">
                ...
                <div class="modal-body table-cnt">
                    <table id="remaining-materials-table"
                        ...
                        <tr>
                            <th class="select-all w-5">
                                <div class='icheck-primary d-inline'>
                                    <input class='js-course-checkbox' type='checkbox' id='all-remainings-checkbox'
                                           autocomplete='off'>
                ...
                <div class="col-xl-9 col-lg-7 col-md-12">
                    ...
                    <div class="tab-content">
                        ...
                        <div id="settings" class="tab-pane show active">
                            ...
                            <form id="edit-course-form" action="{{ route('course.update', $course->id) }}" method="POST"
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control @error('summary') is-invalid @enderror" id="summary"
                                              name="summary" rows="4"
                                              placeholder="Εισάγετε σύνοψη...">{{ old('summary') != "" ? old('summary') : $course['summary'] }}</textarea>
                                    @error('summary')
                                    <span class="invalid-feedback" role="alert">
											<strong>{{ $message }}</strong>
										</span>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control @error('description') is-invalid @enderror"
                                              ...
                                              placeholder="Εισάγετε περιγραφή...">{{ old('description') != "" ? old('description') : $course['description'] }}</textarea>
                                    @error('description')
                                    <span class="invalid-feedback" role="alert">
											<strong>{{ $message }}</strong>
										</span>
                        ...
                        <div id="materials" class="tab-pane table-cnt mb-3">
                            <table id="course-materials-list" data-course-id="{{ $course['id'] }}"
                                   class="table w-100 nowrap center-not-second js-remove-table-classes js-table">
                                <thead>
                                <tr>
                                    <th class="text-center">
                                        <div class='icheck-primary d-inline'>
                                            <input type='checkbox' id='all-active-materials-checkbox'
                                                   autocomplete='off'>
                                ...
                                <div class="col-sm-11 d-flex justify-content-end">
                                    ...
                                    <div class="dropdown ml-2">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right"
                                            ...
                                            <a id="remove-selection-btn" class="dropdown-item" href="#">Αφαίρεση
                                                επιλογών</a>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="col-sm-11 d-flex justify-content-end">
                                    ...
                                    <div class="dropdown ml-2">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right"
                                             aria-labelledby="dropdownMenuButton">
                                            <a id="remove-selected-users-btn" class="dropdown-item" href="#">Αφαίρεση
                                                επιλογών</a>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="col-xl-3 col-lg-5 col-md-12">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between">
                                ...
                                <input type="checkbox" id="active-switch"
                                       {{ $course['active'] == 1 ? "checked" : "" }} data-switch="bool"/>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form id="cover-dropzone" action="/" method="post" class="image-dropzone"
