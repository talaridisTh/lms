				...
				<div class="col-xl-9 col-lg-7 col-md-12">
					...
					<div class="tab-content">
						...
						<div id="settings" class="tab-pane show active">
							...
							<form id="edit-course-form" action="courses/store" method="POST" enctype="multipart/form-data" autocomplete="off">
						...
						<div id="materials" class="tab-pane table-cnt mb-3">
							<table id="course-materials-list" class="table w-100 nowrap center-not-second js-remove-table-classes js-table">
								<thead>
									<tr>
										<th class="text-center">
											<div class='icheck-primary d-inline'>
