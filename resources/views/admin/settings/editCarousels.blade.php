...
@section('content')
    ...
    <div id="edit-banners-modal"
         class="modal fade"
         tabindex="-1"
         role="dialog"
         aria-labelledby="edit-banners-modalLabel"
         aria-hidden="true">
            ...
            <div class="modal-content">
                <div class="modal-header modal-colored-header bg-primary">
                    <h5 class="modal-title"
                        id="edit-banners-modalLabel">Modal title</h5>
                    <button type="button"
                            class="close"
                            data-dismiss="modal"
                            aria-label="Close">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <h4 id="table-title"
                                class="text-center">Courses</h4>
                        </div>
                        <div class="col-md-6">
                            <div id="type-select-cnt"
                                 class="row">
                                <label class="col-3 text-right align-self-center"
                                       for="type-select">Κατηγορία</label>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div id="courses-card"
                                 class="js-category-table-cnt card h-100">
                                <div class="card-body">
                                    <table id="courses-datatable"
                                           class="table w-100 js-remove-table-classes">
                                        <thead>
                                        <tr>
                            ...
                            <div id="bundles-card"
                                 class="js-category-table-cnt card h-100 d-none">
                                <div class="card-body">
                                    <table id="bundles-datatable"
                                           class="table w-100 js-remove-table-classes">
                                        <thead>
                                        <tr>
                                            <th class="text-center">Τίτλος</th>
                            ...
                            <div id="materials-card"
                                 class="js-category-table-cnt card h-100 d-none">
                                <div class="card-body">
                                    <table id="materials-datatable"
                                           class="table w-100 js-remove-table-classes">
                                        <thead>
                                        <tr>
                                            <th class="text-center">Τίτλος</th>
                        ...
                        <div class="col-md-6">
                            @foreach ($banners as $section => $values)
                                <div id="{{ $section }}-banner-selection"
                ...
                <div class="modal-footer">
                    <button id="save-banners-btn"
                            type="button"
                            class="btn btn-primary">Αποθήκευση
                    </button>
                    <button type="button"
                ...
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item"><a href="/dashboard"
                                                       class="custom-link-primary">Dashboard</a></li>
            ...
            <div class="tab-content">
                ...
                @foreach ($banners as $section => $values)
                    <div id="{{ $section }}-carousel"
                         class="tab-pane{{ $counter ? " show active" : "" }}">
                        <div class="d-flex justify-content-end align-items-center mb-3">
                            <button type="button"
                                    class="btn btn-primary btn-sm"
                                    data-toggle="modal"
                                    data-target="#edit-banners-modal"
                                    data-importance="{{ $section }}"
                                    data-modal-title="{{ucfirst($section) }} Carousel">Αλλαγή
                            </button>
                            <input type="checkbox"
                                   id="{{ $section }}-banners-switch"
                                   autocomplete="off"
                                   {{ !empty($values->status) && $values->status == 1 ? "checked" : ""}}
                                   class="js-carousel-switch"
                                   data-switch="success"/>
                            <label for="{{ $section }}-banners-switch"
                                   class="ml-1 mb-0"
                                   data-on-label="On"
                                   data-off-label="Off"></label>
                        </div>
                        <div id="{{ $section }}-banners-row"
                             class="js-banner-cnt row"
                             data-plugin="dragula"
                             data-importance="{{ $section }}">
                            @if ( !empty($values->models) )
                                @foreach ($values->models as $model)
                                    ...
                                    <div class="col-md-6 col-lg-4 col-xl-3">
                                        <!-- Simple card -->
                                        <div class="js-banner card d-block"
                                             data-model-id="{{ $model->id }}"
                                             data-namespace="{{ get_class($model) }}">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="d-flex justify-content-end mt-1 mb-2">
                                                    <a href="#"
                                                       class="js-show-more invisible custom-muted font-weight-700">Περισσότερα...</a>
                                                </div>
                                                <a href="/dashboard/{{ $modelType }}s/{{ $model->slug }}/edit"
                                                   class="custom-link-primary mr-3"
