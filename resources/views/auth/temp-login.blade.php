...
<head>
    ...
    <style>
        .login:before {
            background-image: url("{{asset('theme/images/bg-login-page.svg')}}");
        }
    </style>
</head>
<!-- END: Head -->
        ...
        <form method="POST" class="h-screen xl:h-auto flex py-5 xl:py-0 my-10 xl:my-0" action="{{ route('login') }}">
            ...
            <div
                ...
                @if (Route::has('password.request'))
                    <div class="intro-x flex text-gray-700 dark:text-gray-600 text-xs sm:text-sm mt-4">
                        <div class="flex items-center mr-auto">
                            <input type="checkbox" class="input border mr-2" id="remember"
                ...
                <div class="intro-x mt-5 xl:mt-8 text-center xl:text-left">
                    <button class="button button--lg w-full xl:w-32 text-white bg-theme-6 xl:mr-3 align-top">Σύνδεση
                    </button>
                    <button
