...
class WatchlistCourseDatatable extends DataTable {
    ...
    public function dataTable($query)
    {
        ...
        $query = auth()->user()->watchlistCourse()->get();
        ...
        return datatables()::of($query)
            ...
            ->editColumn("user_id", function ($data) {
                return User::findOrFail($data->user_id)->fullName;
            })
     ...
     *
     * @param \App\WatchlistDatatable $model
    ...
    {
        return $this->builder()
            ->setTableId('watchlistdatatable-table')
