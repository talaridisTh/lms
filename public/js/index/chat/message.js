...
/***/ "./resources/js/index/chat/message.js":
/*!********************************************!*\
  !*** ./resources/js/index/chat/message.js ***!
  \********************************************/
/*! no exports provided */
...
var users = document.querySelectorAll(".js-message-chat");
var authUserId = document.querySelectorAll("#js-chat")[0].dataset.authId;
...
users.forEach(function (user, idx) {
  user.addEventListener("click", function () {
    ...
    // }
    var test = document.querySelector(".unread-message");
    console.log(this);
...
var axiosGetReceiver = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee(receiver) {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return axios.get("/message/".concat(receiver));
  ...
  return function axiosGetReceiver(_x) {
    return _ref.apply(this, arguments);
  };
}();

var axiosGetInfo = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee2(receiver) {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.prev = 0;
            _context2.next = 3;
            return axios.get("/message/info/".concat(receiver));
  ...
  return function axiosGetInfo(_x2) {
    return _ref2.apply(this, arguments);
  };
}();

var onButtonSubmitForm = function onButtonSubmitForm(receiver, message) {
...
channel.bind('my-event', function (data) {
  if (authUserId == data.from) {
    ...
    if (receiverUserId == data.from) {
      ...
      var pending = parseInt($('#user-' + data.from).find('.unread-message').html());
      $('#user-' + data.from).find('.unread-message').html(pending + 1);

      if (pending) {
        $('#user-' + data.from).find('.unread-message').html(pending + 1);
      } else {
        $("#user-".concat(data.from, " .unread-container")).append('<span class="unread-message badge badge-danger-lighten">1</span>');
      }
    }
  }
});

var onPreviewButton = function onPreviewButton(receiver, _ref3) {
  var to = _ref3.to,
      from = _ref3.from,
...
var onKeyUpInput = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee3(receiver) {
  ...
  return function onKeyUpInput(_x3) {
    return _ref4.apply(this, arguments);
  };
}();

var axiosSentMessage = /*#__PURE__*/function () {
  var _ref5 = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee4(receiver, message) {
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            _context4.prev = 0;
            _context4.next = 3;
            return axios.post("/message/sent", {
              receiver: receiver,
              message: message
            });
  ...
  return function axiosSentMessage(_x4, _x5) {
...
var onInitEmoji = function onInitEmoji() {
