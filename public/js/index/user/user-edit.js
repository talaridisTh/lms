...
/***/ "./resources/js/index/user/user-edit.js":
/*!**********************************************!*\
  !*** ./resources/js/index/user/user-edit.js ***!
  \**********************************************/
/*! no exports provided */
...
var initRedactor = function initRedactor() {
...
var onChangeAvatar = function onChangeAvatar() {
  var userSlug = $("#user-slug").data("user-slug");
  $(".cnt-update-user").on("change", "#file-pond", /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee(e) {
      var formData, imagefile, _yield$axios$post, data, status;
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              imagefile = document.querySelector('#file-pond');
              formData.append("file", imagefile.files[0]);
              _context.next = 5;
              return axios.post("/home/account/".concat(userSlug, "/upload-avatar"), formData, {
                headers: {
...
$(".col-span-12").on("click", ".js-update-submit", /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee2() {
  var userSlug, name, last, email, phone, password, password_confirmation, profil, facebook, instagram, linkedin, youtube, _yield$axios$post2, data, status;

  return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee2$(_context2) {
    while (1) {
      switch (_context2.prev = _context2.next) {
        case 0:
          userSlug = $("#user-slug").data("user-slug");
          name = $("#user-update-name").val();
          last = $("#user-update-last").val();
          email = $("#user-update-email").val();
          phone = $("#user-update-phone").val();
          password = $("#user-update-password").val();
          password_confirmation = $("#user-update-repassword").val();
          profil = $("#user-update-profile").val();
          facebook = $("#user-update-facebook").val();
          instagram = $("#user-update-instagram").val();
          linkedin = $("#user-update-linkedin").val();
          youtube = $("#user-update-youtube").val();
          _context2.next = 14;
          return axios.post("/home/account/".concat(userSlug, "/update"), {
            name: name,
            last: last,
            email: email,
            phone: phone,
