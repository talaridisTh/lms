...
(function setOldRecipients() {
  var userRows = $(".js-old-recipients");
  var recipients = [];
...
function removeRecipientHandler() {
  ...
  var recipientIndex = recipients.indexOf(id);
  var newRecipients = sessionStorage.getItem("new_recipients").split(",");
  var newRecipientIndex = newRecipients.indexOf(id);
...
function updateRecipients(ids) {
  ...
  if (recipients === "") {
    recipients = "".concat(ids.toString());
  } else {
    recipients += ",".concat(ids.toString());
  }
...
function updateNewRecipients(ids) {
  var recipients = sessionStorage.getItem("new_recipients");
...
$("#add-recipients-blk").on("click", function () {
  var recipients = sessionStorage.getItem("recipients").split(",");
  var newRecipients = sessionStorage.getItem("new_recipients") === null ? [] : sessionStorage.getItem("recipients").split(",");
