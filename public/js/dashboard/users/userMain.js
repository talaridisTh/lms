...
var tables = $("#scroll-horizontal-datatable").DataTable({
  ...
  }, // 3
  {
    data: "roles",
    name: "roles.name",
    className: "align-middle text-center role-user"
  }, // 4
  {
    data: "phone",
    name: "phone",
...
_main__WEBPACK_IMPORTED_MODULE_1__["default"].filterButton('#activeFilter', 7, tables, "#scroll-horizontal-datatable_length label");
_main__WEBPACK_IMPORTED_MODULE_1__["default"].filterButton('#rolesFilter', 4, tables, "#scroll-horizontal-datatable_length label");
_main__WEBPACK_IMPORTED_MODULE_1__["default"].filterButton('#course-filter', 2, tables, "#scroll-horizontal-datatable_length label"); //! EVENT LISTENER
//!============================================================

$("#course-filter").on("change", function () {
  var label = $("#select2-course-filter-container")[0];
...
var searchField = $('#scroll-horizontal-datatable_filter > label ')[0];
var dateInput = createDateElm("users-date-picker");
dateInput.appendBefore(searchField);
$(dateInput).daterangepicker(_main__WEBPACK_IMPORTED_MODULE_1__["default"].datePickerConfig);
...
var axiosMultipleDelete = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee(ids) {
    var _yield$utilities$toas, value, message;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return _main__WEBPACK_IMPORTED_MODULE_1__["default"].toastAlertDelete("\u0397 \u03B5\u03BD\u03AD\u03C1\u03B3\u03B5\u03B9\u03B1 \u03B8\u03B1 \u03B5\u03AF\u03BD\u03B1\u03B9 \u03BC\u03B7 \u03B1\u03BD\u03B1\u03C3\u03C4\u03C1\u03AD\u03C8\u03B9\u03BC\u03B7");
          ...
          case 3:
            ...
            _context.next = 8;
            return axios["delete"]("/user/multiple/users/delete", {
              data: {
                'user_id': ids
              }
            });
          ...
          case 8:
            message = ids.length === 1 ? "Διαγράφηκε" : "Διαγράφηκαν";
            _main__WEBPACK_IMPORTED_MODULE_1__["default"].toastAlert("info", message);
...
var axiosExportUser = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee2(id, that) {
    var result;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.prev = 0;
            _context2.next = 3;
            return _main__WEBPACK_IMPORTED_MODULE_1__["default"].passwordValidation();
  ...
  return function axiosExportUser(_x2, _x3) {
