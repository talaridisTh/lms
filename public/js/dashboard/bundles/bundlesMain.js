...
$("#select-all-bundles").on("change", function () {
  var minorCheckboxes = $(".js-bundle-checkbox");
  var bulkBtn = $("#bundle-bult-btn")[0];
...
$("#delete-bundles-btn").on("click", function () {
  ...
  Swal.fire({
    ...
    html: checkedBoxes.length == 1 ? "<p class='mb-0'>Το Bundle θα διαγραφεί.</p>Η ενέργεια θα είναι μη αναστρέψιμη!" : "<p class=\"mb-0\">".concat(ids.length, " Bundles \u03B8\u03B1 \u03B4\u03B9\u03B1\u03B3\u03C1\u03B1\u03C6\u03BF\u03CD\u03BD.</p>\u0397 \u03B5\u03BD\u03AD\u03C1\u03B3\u03B5\u03B9\u03B1 \u03B8\u03B1 \u03B5\u03AF\u03BD\u03B1\u03B9 \u03BC\u03B7 \u03B1\u03BD\u03B1\u03C3\u03C4\u03C1\u03AD\u03C8\u03B9\u03BC\u03B7!"),
    icon: 'warning',
    ...
    if (result.value) {
      axios["delete"]("/bundle-ajax/destroy/".concat(ids)).then(function (response) {
...
var bundlesDatatable = $("#bundle-table").DataTable({
  ...
  drawCallback: function drawCallback() {
    ...
    activeToggleInit();
    checkboxChangeInit();
    _main__WEBPACK_IMPORTED_MODULE_0__["default"].resetBulk($("#bundle-bult-btn"), $("#select-all-bundles"));
  }
});

function checkboxChangeInit() {
  var minorCheckboxes = $(".js-bundle-checkbox");
  var mainCheckbox = $("#select-all-bundles")[0];
  var bulkBtn = $("#bundle-bult-btn")[0];
...
function activeToggleInit() {
  ...
  toggle.on("change", function () {
    ...
    var id = this.dataset.bundleId;
    axios.patch("/bundle-ajax/".concat(id, "/status"), {
...
module.exports = __webpack_require__(/*! C:\Users\arxi-\OneDrive\Υπολογιστής\lmsdemo-master\resources\js\dashboard\bundles\bundlesMain.js */"./resources/js/dashboard/bundles/bundlesMain.js");
