...
function showEditInit() {
  ...
  editBtns.on("click", function () {
    ...
    var inputContainer = row.getElementsByClassName("js-edit")[0];
...
function editButtonsInit() {
  var input = $(".js-edit input");
  var save = $(".js-save");
  var cancel = $(".js-cancel");
  save.on("click", function () {
    var td = this.findParent(4);
  ...
  cancel.on('click', function () {
    ...
    var inputCnt = td.getElementsByClassName("js-edit")[0];
    var input = inputCnt.getElementsByTagName("input")[0];
  ...
  input.on("keyup", function () {
    if (event.keyCode == 13) {
      ...
      var td = this.findParent(3);
      var title = td.getElementsByClassName("js-title")[0];
      var inputCnt = this.findParent(2);
      title.classList.remove("d-none");
      inputCnt.classList.add("d-none");
      updateTopic(this);
    }
...
function updateTopic(input) {
  ...
  axios.patch("/topics/update/".concat(id), {
    ...
    if (err.response.status == 422) {
      _main__WEBPACK_IMPORTED_MODULE_0__["default"].toastAlert("info", "Το topic ήδη υπάρχει..."); // input.value = input.defaultValue;
    } else {
