...
var trash = 0;
var dataRange = $("#daterange"); //! INIT DATATABLE
//!============================================================
...
var materialsDatatable = $("#materials-datatable").DataTable({
  ...
  drawCallback: function drawCallback() {
    ...
    _main__WEBPACK_IMPORTED_MODULE_1__["default"].resetBulk($("#course-bulk-action-btn"), $(".js-material-checkbox"));
    toggleInit();
...
_main__WEBPACK_IMPORTED_MODULE_1__["default"].filterButton('#activeFilterMaterial', 2, materialsDatatable, "#materials-datatable_length label");
_main__WEBPACK_IMPORTED_MODULE_1__["default"].filterButton('#typeFilterMaterial', 3, materialsDatatable, "#materials-datatable_length label"); // utilities.filterButton('#courseFilterMaterial', 6, materialsDatatable,"#materials-datatable_length label");
...
$("#daterange").detach().insertBefore('#materials-datatable_filter > label '); //! METHOD FIRST TABLE
//!============================================================
...
function toggleInit() {
  $(".js-toggle").change(function () {
    ...
    var materialSlug = this.parentElement.parentElement.dataset.materialSlug; // let updatedAtCnt = this.parentElement.parentElement.getElementsByClassName("js-updated-at")[0];

    axios.patch("/materials/toggle-status/".concat(materialSlug), {
      state: this.checked ? 1 : 0
    }).then(function (res) {
      var icon = _this.checked ? "success" : "info";
      var message = _this.checked ? "Ενεργοποιήθηκε" : "Απενεργοποιήθηκε";
      _main__WEBPACK_IMPORTED_MODULE_1__["default"].toastAlert(icon, message); // updatedAtCnt.textContent = "Μόλις τώρα";
    })["catch"](function (err) {
      console.log(err);
...
$("#courseFilterMaterial").change(function () {
  var label = $("#select2-courseFilterMaterial-container")[0];
  _main__WEBPACK_IMPORTED_MODULE_1__["default"].filterStyle(label, this.value);
});
$("#typeFilterMaterial").change(function () {
  var label = $("#select2-typeFilterMaterial-container")[0];
  _main__WEBPACK_IMPORTED_MODULE_1__["default"].filterStyle(label, this.value);
});
$("#activeFilterMaterial").change(function () {
  var label = $("#select2-activeFilterMaterial-container")[0];
  _main__WEBPACK_IMPORTED_MODULE_1__["default"].filterStyle(label, this.value);
}); //! SELECT
//!============================================================

$("#courseFilterMaterial").select2({
  text: '' // minimumInputLength: 2,
...
var axiosMultipleDelete = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee(ids) {
    var _yield$utilities$toas, value, res;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return _main__WEBPACK_IMPORTED_MODULE_1__["default"].toastAlertDelete("\u0398\u03AD\u03BB\u03B5\u03C4\u03B5 \u03BD\u03B1 \u03B1\u03C6\u03B1\u03B9\u03C1\u03AD\u03C3\u03B5\u03C4\u03B5 \u03C4\u03BF ".concat(ids.length, " \u03B1\u03C0\u03BF \u03C4\u03BF\u03BD \u03C7\u03C1\u03AE\u03C3\u03C4\u03B7 "));
          ...
          case 3:
            ...
            _context.next = 8;
            return axios["delete"]("/material-ajax/delete", {
              data: {
                'material_id': ids
              }
            });
          ...
          case 8:
            ...
            if (res.status == 200) {
              ...
              _main__WEBPACK_IMPORTED_MODULE_1__["default"].toastAlert("success", "".concat(ids.length, " \u0394\u03B9\u03B1\u03B3\u03C1\u03AC\u03C6\u03B9\u03BA\u03B1\u03BD"));
              materialsDatatable.ajax.reload();
            }
...
var selectStatusMultiple = function selectStatusMultiple() {
  ...
  $(".js-multiple-change").click(function () {
    var checkboxes = $(".js-material-checkbox:checked");
    var ids = [];
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.prev = 0;
            _context2.next = 3;
            return axios.patch("/material-ajax/bulk-toggle-status", {
              "material_id": ids,
              "status": stat
            });
...
module.exports = __webpack_require__(/*! C:\Users\arxi-\OneDrive\Υπολογιστής\lmsdemo-master\resources\js\dashboard\materials\materialsMain.js */"./resources/js/dashboard/materials/materialsMain.js");
