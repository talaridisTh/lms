...
/***/ "./resources/js/dashboard/settings/settings-index.js":
/*!***********************************************************!*\
  !*** ./resources/js/dashboard/settings/settings-index.js ***!
  \***********************************************************/
/*! no exports provided */
...
var optionsDataTable = $("#options-datatable").DataTable({
  order: [0, "desc"],
  processing: true,
  serverSide: true,
  ajax: {
  ...
  fnInitComplete: function fnInitComplete(oSettings, json) {
    var lenthSelection = $("select[name='options-datatable_length']");
...
function quickEditBtnInit() {
  ...
  $(".js-save").on("click", function () {
    var td = this.findParent(2);
    var id = this.dataset.optionId;
    var name = td.getElementsByClassName("js-option-name")[0].value;
    var value = td.getElementsByClassName("js-option-value")[0].value;
...
function _deleteBtnHandler() {
  _deleteBtnHandler = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee() {
    var _yield$swalDelete, isConfirmed;
    ...
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 7:
            _context.next = 9;
            return axios["delete"]("/option/".concat(this.dataset.optionId));

          case 9:
            optionsDataTable.ajax.reload(null, false);
            _main__WEBPACK_IMPORTED_MODULE_1__["default"].toastAlert("info", "Διαγράφηκε...");
            _context.next = 17;
            break;
          ...
          case 13:
            ...
            _main__WEBPACK_IMPORTED_MODULE_1__["default"].toastAlert("error", "Ooops...");
...
function classToggler(button, parent) {
  var td = button.findParent(parent);
  var title = td.getElementsByClassName("js-title")[0];
  var inputCnt = td.getElementsByClassName("js-edit-cnt")[0];
  title.classList.toggle("d-none");
  inputCnt.classList.toggle("d-none");
}

function saveOption(id, name, value) {
  axios.patch("/option/".concat(id, "/update"), {
    name: name,
    value: value
  }).then(function (res) {
    optionsDataTable.ajax.reload(null, false);
    _main__WEBPACK_IMPORTED_MODULE_1__["default"].toastAlert("success", "Αποθηκεύτηκε!");
  })["catch"](function (err) {
    console.log(err);
    _main__WEBPACK_IMPORTED_MODULE_1__["default"].toastAlert("error", "Ooops!");
  });
