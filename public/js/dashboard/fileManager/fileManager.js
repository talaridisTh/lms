...
$("#save-details-btn").on("click", function () {
  ...
  axios.post("/file-details-store", data).then(function (res) {
    _main__WEBPACK_IMPORTED_MODULE_1__["default"].toastAlert("success", "Οι αλλαγές αποθηκεύτηκαν.");
    clearInvalidMessage();
...
$("#edit-file-modal").on("show.bs.modal", /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee(event) {
    var modal, td, id, publicPass, copyUrlBtn, urlToggle, placeholder, dialog, res, originalName, title, subtitle, caption, description;
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            modal = $(this);
            td = event.relatedTarget.parentElement;
            id = td.getElementsByClassName("js-id-input")[0];
            publicPass = td.getElementsByClassName("js-public-url-input")[0];
            copyUrlBtn = document.getElementById("copy-url-button");
            urlToggle = document.getElementById("url-toggle");
            placeholder = document.getElementById("edit-media-placeholder");
            dialog = document.getElementById("edit-media-dialog");
            _context.prev = 8;
            _context.next = 11;
            return mediaData(id.value);
          ...
          case 11:
            ...
            if (res.data.media_details) {
              title = res.data.media_details.title;
              subtitle = res.data.media_details.subtitle;
              caption = res.data.media_details.caption;
...
$("#edit-file-modal").on("hidden.bs.modal", function () {
  var placeholder = document.getElementById("edit-media-placeholder");
  var dialog = document.getElementById("edit-media-dialog");
  placeholder.classList.toggle("d-flex");
  placeholder.classList.toggle("d-none");
  dialog.classList.toggle("d-none");
  clearInvalidMessage();
...
function mediaData(id) {
  return axios.get("/media-ajax/".concat(id, "/get-media-details"));
}
...
var fileManagerDatatable = $("#file-manager-datatable").DataTable({
  ...
  ajax: {
    ...
    data: function data(d) {
      return $.extend({}, d, {
        startDate: _main__WEBPACK_IMPORTED_MODULE_1__["default"].startDate($("#bundle-date-range")[0]),
        endDate: _main__WEBPACK_IMPORTED_MODULE_1__["default"].endDate($("#bundle-date-range")[0])
      });
    }
  },
...
function copyHiddenInputClickHandler() {
  ...
  var publicUrl = td.getElementsByClassName("js-public-url-input")[0].value;
...
_main__WEBPACK_IMPORTED_MODULE_1__["default"].ALLOWEDTYPES.push('image/png', 'image/jpeg');
...
module.exports = __webpack_require__(/*! D:\Coding\Darkpony\Idrogeios\lmsdemo\resources\js\dashboard\fileManager\fileManager.js */"./resources/js/dashboard/fileManager/fileManager.js");
